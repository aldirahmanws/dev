    ...
    <div class="modal fade" id="modal-default" >
      ...
      <input type="text" name="id_kp" id="id_kp" class="validate[required] text-input"  size="5" style="width: 90%;">
      <input type="text" name="kode_matkul" id="kode_matkul" class="validate[required] text-input"  size="5" style="width: 90%;">
        </tr> 
                  <tr>
 ...
 <script>
    ...
    $('#nama_matkul').autocomplete({
      source:'<?php echo base_url(); ?>kelas_perkuliahan/get_autocomplete_kp_transfer', 
      minLength:1,
      select: function(event, ui){
        $('#nama_matkul').val(ui.item.label);
        $('#kode_matkul').val(ui.item.km);
