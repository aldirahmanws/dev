...
<form  method="post" action="<?php echo base_url(); ?>mahasiswa/save_edit_mhs/<?php echo $mahasiswa->id_mahasiswa; ?>/<?php echo $mahasiswa->nim; ?>" enctype="multipart/form-data">
          ...
          <div class="modal-dialog">
            <div class="modal-content">
              ...
              <div class="modal-body">
                ...
                <form  method="post" runat="server" action="<?php echo base_url(); ?>mahasiswa/save_edit_foto_mahasiswa/<?php echo $mahasiswa->id_mahasiswa; ?>" enctype="multipart/form-data">
                  <div class="box-body">
                    <div class="box-body">
